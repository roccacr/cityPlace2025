                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="https://demo.cityplacecr.com/images/Oficinas/LifeMiles/logo1.png" alt=" Life Miles Costa Rica" class="sg-mb-30px sg-hero-logo invert" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                                ...
                                                LifeMiles es el programa de viajero frecuente de Avianca, el cual unificó lo mejor de los programas AviancaPlus y DISTANCIA. LifeMiles es un programa donde puedes acumular y redimir tus millas por viajes, noches de hotel, compras de artículos en línea, entradas a parques de diversiones y muchas otras opciones</p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel: (+506) 2299-8222" class="text-white plusicon_ar topLinkGold">(+506) 2299-8222</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:soporte@lifemiles.com" class="text-white topLinkGold">soporte@lifemiles.com</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel: (+506) 2299-8222" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>(+506) 2299-8222</span>
                                            </a>
                                            <a href="tel: (+506) 2299-8222" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>(+506) 2299-8222</span>
                                            </a>
                                            <a href="mailto:soporte@lifemiles.com" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-envelope"></span>
                                                <span>soporte@lifemiles.com</span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="https://demo.cityplacecr.com/images/Oficinas/LifeMiles/banner2.webp" data-alt="Life Miles Costa Rica"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="https://demo.cityplacecr.com/images/Oficinas/LifeMiles/banner2.webp" data-alt="Life Miles Costa Rica"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="https://demo.cityplacecr.com/images/Oficinas/LifeMiles/banner2.webp" data-alt="Life Miles Costa Rica"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="https://demo.cityplacecr.com/images/Oficinas/LifeMiles/banner2.webp" data-alt="Life Miles Costa Rica"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Lifes Miles </h5>

                                        <h2 class="sg-mb-20px">Vive tus millas,
Vive más </h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            <p class="clearfix">
                                            Usa tus LifeMiles para viajar por el mundo
                                            </p>
                                           
                                            <p>
                                                <a href="https://www.lifemiles.com/" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Visita Página</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Oficinas/LifeMiles/1.webp" class="bg-image lazyload" data-alt="Life Miles Costa Rica"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Oficinas/LifeMiles/2.jpg" class="bg-image lazyload" data-alt="Life Miles Costa Rica"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Oficinas/LifeMiles/3.jpg" class="bg-image lazyload" data-alt="Life Miles Costa Rica"></div>
                                    </figure>
                                </div>
