                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="./images/NUEVOS/macrobiotica/MNPLogo.svg" alt="Macrobiotica Natural Planet" class="sg-mb-30px sg-hero-logo invert" style="min-height: auto; width: 200px;" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                            En Macrobiótica Natural Planet, creemos que la salud comienza con elecciones conscientes. Por eso, te ofrecemos una selección de productos naturales, orgánicos y macrobióticos que nutren tu cuerpo y armonizan tu mente. Nuestro compromiso es acompañarte hacia un estilo de vida más saludable y sostenible
                                            </p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel: +506 4035-3111" class="text-white plusicon_ar topLinkGold">+506 8357-9090</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:store_uae_dubai-mall@bulgari.com" class="text-white topLinkGold">info@naturalplanet.cr</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <a href="mailto:store_uae_dubai-mall@bulgari.com" class="btn btn-default-transparent text-uppercase visible-xs">
                                                ...
                                                <span>info@naturalplanet.cr</span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="./images/NUEVOS/macrobiotica/1.png" data-alt="Macrobiotica Natural Planet"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="./images/NUEVOS/macrobiotica/1.png" data-alt="Macrobiotica Natural Planet"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="./images/NUEVOS/macrobiotica/1.png" data-alt="Macrobiotica Natural Planet"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="./images/NUEVOS/macrobiotica/1.png" data-alt="Macrobiotica Natural Planet"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Macrobiotica Natural Planet</h5>

                                        <h2 class="sg-mb-20px">¡Ven con nosotros y descubre lo mejor para tu bienestar!</h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            <p class="clearfix">
                                            Productos macrobióticos, Asesoría naturista, Asesoría psicológica, Asesoría nutricional
                                            </p>

                                            <p><strong>Seguinos</strong></p>
                                            <p>
                                                <a href="https://www.instagram.com/macrobioticanaturalplanetcr?igsh=Nzd5dzA0NmM2azA5" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Instagram</a>
                                            </p>
                                            <p>
                                                <a href="https://shop.naturalplanet.cr/" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Sitio Web</a>
                                            </p>
