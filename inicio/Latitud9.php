                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="https://demo.cityplacecr.com/images/logos/latitud9.png" alt="Bvlgari" class="sg-mb-30px sg-hero-logo invert" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                                Cocktail bar, con combinaciones de sabores, aromas y experiencias multisensoriales que crean un equilibrio perfecto.</p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel: +506 4035-3111" class="text-white plusicon_ar topLinkGold">+506 4035-3111</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:store_uae_dubai-mall@bulgari.com" class="text-white topLinkGold">latitud9@cityplacecr.com</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <a href="mailto:store_uae_dubai-mall@bulgari.com" class="btn btn-default-transparent text-uppercase visible-xs">
                                                ...
                                                <span>latitud9@cityplacecr.com</span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="https://demo.cityplacecr.com/images/Restaurantes/Latitud/banner.webp" data-alt="Bulgari"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="https://demo.cityplacecr.com/images/Restaurantes/Latitud/banner.webp" data-alt="Bulgari"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="https://demo.cityplacecr.com/images/Restaurantes/Latitud/banner.webp" data-alt="Bulgari"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="https://demo.cityplacecr.com/images/Restaurantes/Latitud/banner.webp" data-alt="Bulgari"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Latitud 9</h5>

                                        <h2 class="sg-mb-20px">Eat, Drink, Enjoy </h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            <p class="clearfix">
                                                Latitud 9 posee un menú que engloba diferentes elementos, técnicas y sabores que se combinan para crear platos especiales. La mayoría se basa en la cocina mediterránea, asiática y latinoamericana, creando una fusión que deleita el paladar.
                                            </p>

                                            <p>
                                                <a href="https://www.facebook.com/Latitud9Bar" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Más Información</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Restaurantes/Latitud/2.jpg" class="bg-image lazyload" data-alt="Bulgari"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Restaurantes/Latitud/3.jpg" class="bg-image lazyload" data-alt="Bulgari"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Restaurantes/Latitud/5.webp" class="bg-image lazyload" data-alt="Bulgari"></div>
                                    </figure>
                                </div>
