                    ...
                    <div class="block col-xs-24" data-block>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-11 col-sm-offset-1">
                                        <p class="text-uppercase text-white sg-mb-20px">Oficinas</p>
                                        <h1 class="view-panel__heading text-white sg-mb-20px">Tus oficina en<br>City Place<h1>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-11 col-sm-offset-1">
                        ...
                        <div class="block-visuals">
                            <figure class="block-cover-img">
                                <div class="bg-image lazyload" id="bg-img-stay-hero" style="background-image: url(https://demo.cityplacecr.com/images/Categorias/oficinas.png);"></div>
                            </figure>
                        </div>
                    </div>
                </div>
            ...
            <div class="block-container">
                <div class="block-abs">
                    <div class="block block-border-right col-md-12 col-sm-12 block-white" data-block>
                                ...
                                <div class="row">
                                    <div class="col-sm-22 col-sm-offset-1 text-white">
                                        <div class="visible-xs">
                                            <h1 class="sg-mb-10px"> Abbott</h1>
                                        </div>
                                        <div class="hidden-xs">
                                            <h2 class="sg-mb-10px"> Abbott</h2>
                                            <p class="text-white sg-mb-20px hidden-xs">

                                               Hoy, 113,000 de nosotros estamos trabajando para ayudar a las personas a vivir no solo por más tiempo, sino mejor, en los más de 160 países a los que servimos.
                                            </p>
                                        </div>
                                        <a href="Abbott.php"  class="stayExploreMoreCTA btn btn-default-transparent btn-block-sm text-uppercase margin-right-xs-px">
                                            MÁS INFORMACIÓN
                        ...
                        <div class="block-visuals">
                            <figure class="block-cover-img">
                                <div data-bgset="https://demo.cityplacecr.com/images/tiendas/Abbott.jpg" class="bg-image lazyload" data-alt="Abbott City Place"></div>
                            </figure>
                        </div>
                    </div>
                    ...
                    <div class="block block-border-left col-md-12 col-sm-12 block-white" data-block>
                        <div class="block-bottom sg-mb-40px blockStayText">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-22 col-sm-offset-1 text-white">
                                        <div class="visible-xs">
                                            <h1 class="sg-mb-10px">Booking.com</h1>
                                        </div>
                                        <div class="hidden-xs">
                                            <h2 class="sg-mb-10px">Booking.com</h2>
                                            <p class="text-white sg-mb-20px hidden-xs">
                                             Con más de 2 millones de propiedades en más de 225 países de todo el mundo, hacemos que sea fácil encontrar y reservar su lugar perfecto al precio correcto.
                                            </p>
                                        </div>
                                        <a href="Bookingcom.php"  class="stayExploreMoreCTA btn btn-default-transparent btn-block-sm text-uppercase margin-right-xs-px">
                                            MÁS INFORMACIÓN
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="block-visuals">
                            <figure class="block-cover-img">
                                <div data-bgset="https://demo.cityplacecr.com/images/tiendas/booking.jpg" class="bg-image lazyload" data-alt="Booking.com City Place"></div>
                            </figure>
                        </div>
                    </div>
                </div>
            ...
            <div class="block-container">
                <div class="block-abs">
                    <div class="block block-border-right col-md-12 col-sm-12 block-white" data-block>
                        <div class="block-bottom sg-mb-40px blockStayText">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-22 col-sm-offset-1 text-white">
                                        <div class="visible-xs">
                                            <h1 class="sg-mb-10px">Cinko</h1>
                                        </div>
                                        <div class="hidden-xs">
                                            <h2 class="sg-mb-10px">Cinko</h2>
                                            <p class="text-white sg-mb-20px hidden-xs">

                                            Con CiNKO, puedes recibir Bitcoin, Ethereum, USDC y PayPal USD, y convertirlo en dólares al instante. CiNKO es la solución completa para todas tus necesidades financieras. Retira efectivo en 180 países con CiNKO y MoneyGram.
                                            </p>
                                        </div>
                                        <a href="cinko.php"  class="stayExploreMoreCTA btn btn-default-transparent btn-block-sm text-uppercase margin-right-xs-px">
                                            MÁS INFORMACIÓN
                        ...
                        <div class="block-visuals">
                            <figure class="block-cover-img">
                                <div data-bgset="images/NUEVOS/cinko/2.jpeg" class="bg-image lazyload" data-alt="FT Technologies"></div>
                            </figure>
                        </div>
                    </div>
                    ...
                    <div class="block block-border-left col-md-12 col-sm-12 block-white" data-block>
                        <div class="block-bottom sg-mb-40px blockStayText">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-22 col-sm-offset-1 text-white">
                                        <div class="visible-xs">
                                            <h1 class="sg-mb-10px"> Kraft-Heinz </h1>
                                        </div>
                                        <div class="hidden-xs">
                                            <h2 class="sg-mb-10px">Kraft-Heinz</h2>
                                            <p class="text-white sg-mb-20px hidden-xs">
                                            En Kraft Heinz nos encargamos de hacer la vida deliciosa para nuestros consumidores, estamos en el sector de alimentos y en city place tenemos nuestras oficinas administrativas.
                                            </p>
                                        </div>
                                        <a href="KraftHeinz.php"  class="stayExploreMoreCTA btn btn-default-transparent btn-block-sm text-uppercase margin-right-xs-px">
                                            MÁS INFORMACIÓN
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="block-visuals">
                            <figure class="block-cover-img">
                                <div data-bgset="https://demo.cityplacecr.com/images/Oficinas/KraftHeinz/5.jpg" class="bg-image lazyload" data-alt="Kraft-Heinz City Place"></div>
                            </figure>
                        </div>
                    </div>
                </div>
            ...
            <div class="block-container">
                <div class="block-abs">
                    <div class="block block-border-right col-md-12 col-sm-12 block-white" data-block>
                        <div class="block-bottom sg-mb-40px blockStayText">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-22 col-sm-offset-1 text-white">
                                        <div class="visible-xs">
                                            <h1 class="sg-mb-10px">CriticalRiver</h1>
                                        </div>
                                        <div class="hidden-xs">
                                            <h2 class="sg-mb-10px">CriticalRiver</h2>
                                            <p class="text-white sg-mb-20px hidden-xs">

                                            CriticalRiver es una empresa líder en consultoría de tecnología digital, especializada en Transformación Digital, Experiencia del Cliente, Compromiso Digital e Ingeniería Digital.
                                            </p>
                                        </div>
                                        <a href="criticalriver.php"  class="stayExploreMoreCTA btn btn-default-transparent btn-block-sm text-uppercase margin-right-xs-px">
                                            MÁS INFORMACIÓN
                        ...
                        <div class="block-visuals">
                            <figure class="block-cover-img">
                                <div data-bgset="images/NUEVOS/criticalriver/1.jpeg" class="bg-image lazyload" data-alt="FT Technologies"></div>
                            </figure>
                        </div>
                    </div>
                    ...
                    <div class="block block-border-left col-md-12 col-sm-12 block-white" data-block>
                        <div class="block-bottom sg-mb-40px blockStayText">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-22 col-sm-offset-1 text-white">
                                        <div class="visible-xs">
                                            <h1 class="sg-mb-10px">Void</h1>
                                        </div>
                                        <div class="hidden-xs">
                                            <h2 class="sg-mb-10px">Void</h2>
                                            <p class="text-white sg-mb-20px hidden-xs">
                                            Estudio internacional de arquitectura sostenible, planeamiento urbano y diseño.
                                            </p>
                                        </div>
                                        <a href="void.php"  class="stayExploreMoreCTA btn btn-default-transparent btn-block-sm text-uppercase margin-right-xs-px">
                                            MÁS INFORMACIÓN
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="block-visuals">
                            <figure class="block-cover-img">
                                <div data-bgset="images/NUEVOS/void/1.jpg" class="bg-image lazyload" data-alt="Kraft-Heinz City Place"></div>
                            </figure>
                        </div>
                    </div>
                </div>
            ...
            <div class="block-container">
                <div class="block-abs">
                        ...
                        <div class="block-bottom sg-mb-40px blockStayText">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-22 col-sm-offset-1 text-white">
                                        <div class="visible-xs">
                                            <h1 class="sg-mb-10px">Newmark</h1>
                                        </div>
                                        <div class="hidden-xs">
                    ...
                    <div class="block block-border-left col-md-12 col-sm-12 block-white" data-block>
                        <div class="block-bottom sg-mb-40px blockStayText">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-22 col-sm-offset-1 text-white">
                                        <div class="visible-xs">
                                            <h1 class="sg-mb-10px">MSD | Costa Rica</h1>
                                        </div>
                                        <div class="hidden-xs">
                                            <h2 class="sg-mb-10px">MSD | Costa Rica</h2>
                                            <p class="text-white sg-mb-20px hidden-xs">

                                                Desempeñamos un papel importante en el descubrimiento y desarrollo de medicamentos y vacunas innovadores para tratar y prevenir enfermedades infecciosas, como el VIH y el ébola. </p>
                                        </div>
                                        <a href="MSD.php"  class="stayExploreMoreCTA btn btn-default-transparent btn-block-sm text-uppercase margin-right-xs-px">
                                            MÁS INFORMACIÓN
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="block-visuals">
                            <figure class="block-cover-img">
                                <div data-bgset="https://demo.cityplacecr.com/images/tiendas/msg.png" class="bg-image lazyload" data-alt="MSD City Place "></div>
                            </figure>
                        </div>
                    </div>
                </div>
            ...
            <div class="block-container">
                <div class="block-abs">
                    <div class="block block-border-right col-md-12 col-sm-12 block-white" data-block>
                        <div class="block-bottom sg-mb-40px blockStayText">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-22 col-sm-offset-1 text-white">
                                        <div class="visible-xs">
                                            <h1 class="sg-mb-10px">LifeMiles</h1>
                                        </div>
                                        <div class="hidden-xs">
                                            <h2 class="sg-mb-10px">LifeMiles</h2>
                                            <p class="text-white sg-mb-20px hidden-xs">


                                                Somos el programa de lealtad y de viajero frecuente de Avianca con más de nueve millones de socios, quienes acumulan y redimen millas en una amplia red de aliados.
                                            </p>
                                        </div>
                                        <a href="LifeMiles.php"  class="stayExploreMoreCTA btn btn-default-transparent btn-block-sm text-uppercase margin-right-xs-px">
                                            MÁS INFORMACIÓN
                        ...
                        <div class="block-visuals">
                            <figure class="block-cover-img">
                                <div data-bgset="https://demo.cityplacecr.com/images/tiendas/life.png" class="bg-image lazyload" data-alt="LifeMiles City Place"></div>
                            </figure>
                        </div>
                    </div>
                    ...
                    <div class="block block-border-left col-md-12 col-sm-12 block-white" data-block>
                        <div class="block-bottom sg-mb-40px blockStayText">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-22 col-sm-offset-1 text-white">
                                        <div class="visible-xs">
                                            <h1 class="sg-mb-10px">Rocca Development Group</h1>
                                        </div>
                                        <div class="hidden-xs">
                                            <h2 class="sg-mb-10px">Rocca Development Group</h2>
                                            <p class="text-white sg-mb-20px hidden-xs">

                                                Es una empresa de capital costarricense fundada a finales de los años 80, con el fin primordial de diseñar y construir proyectos de toda índole
                                            </p>
                                        </div>
                                        <a href="Rocca.php"  class="stayExploreMoreCTA btn btn-default-transparent btn-block-sm text-uppercase margin-right-xs-px">
                                            MÁS INFORMACIÓN
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="block-visuals">
                            <figure class="block-cover-img">
                                <div data-bgset="https://demo.cityplacecr.com/images/tiendas/rocca.jpg" class="bg-image lazyload" data-alt="Rocca Development Group City Place"></div>
                            </figure>
                        </div>
                    </div>
                </div>
            ...
            <div class="block-container">
                <div class="block-abs">
                    <div class="block block-border-right col-md-12 col-sm-12 block-white" data-block>
                        <div class="block-bottom sg-mb-40px blockStayText">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-22 col-sm-offset-1 text-white">
                                        <div class="visible-xs">
                                            <h1 class="sg-mb-10px">Corebases</h1>
                                        </div>
                                        <div class="hidden-xs">
                                            <h2 class="sg-mb-10px">Corebases</h2>
                                            <p class="text-white sg-mb-20px hidden-xs">
                                                Desarrollando Aplicaciones y Software desde 2006
                                                Cuando des el paso y te decidas por crear una aplicación para tu empresa,
                                                desarrollaremos lo mejor es que se adapte a tus necesidades.
                                                Utilizando el mejor software tendras las mejores soluciones.
                                            </p>
                                        </div>
                                        <a href="Corebases.php"  class="stayExploreMoreCTA btn btn-default-transparent btn-block-sm text-uppercase margin-right-xs-px">
                                            MÁS INFORMACIÓN
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="block-visuals">
                            <figure class="block-cover-img">
                                <div data-bgset="https://demo.cityplacecr.com/images/Oficinas/Corebases/4.jpeg" class="bg-image lazyload" data-alt="Corebases City Place"></div>
                            </figure>
                        </div>
                    </div>
                    ...
                    <div class="block block-border-left col-md-12 col-sm-12 block-white" data-block>
                        <div class="block-bottom sg-mb-40px blockStayText">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-22 col-sm-offset-1 text-white">
                                        <div class="visible-xs">
                                            <h1 class="sg-mb-10px">HP Inc</h1>
                                        </div>
                                        <div class="hidden-xs">
                                            <h2 class="sg-mb-10px">HP Inc</h2>
                                            <p class="text-white sg-mb-20px hidden-xs">

                                            HP Inc. es una empresa de tecnología que cree que una idea bien pensada tiene el poder de cambiar el mundo.
                                            </p>
                                        </div>
                                        <a href="HpInc.php"  class="stayExploreMoreCTA btn btn-default-transparent btn-block-sm text-uppercase margin-right-xs-px">
                                            MÁS INFORMACIÓN
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="block-visuals">
                            <figure class="block-cover-img">
                                <div data-bgset="https://demo.cityplacecr.com/images/Oficinas/Hp/1.png" class="bg-image lazyload" data-alt="HP Inc City Place"></div>
                            </figure>
                        </div>
                    </div>
                </div>
            ...
            <div class="block-container">
                <div class="block-abs">
                    <div class="block block-border-right col-md-12 col-sm-12 block-white" data-block>
                        <div class="block-bottom sg-mb-40px blockStayText">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-22 col-sm-offset-1 text-white">
                                        <div class="visible-xs">
                                            <h1 class="sg-mb-10px">The Kapital Group</h1>
                                        </div>
                                        <div class="hidden-xs">
                                            <h2 class="sg-mb-10px">The Kapital Group</h2>
                                            <p class="text-white sg-mb-20px hidden-xs">
                                            Grupo de empresas de servicios financieros e inmobiliarios
                                            </p>
                                        </div>
                                        <a href="KapitalGroup.php"  class="stayExploreMoreCTA btn btn-default-transparent btn-block-sm text-uppercase margin-right-xs-px">
                                            MÁS INFORMACIÓN
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="block-visuals">
                            <figure class="block-cover-img">
                                <div data-bgset="https://demo.cityplacecr.com/images/Oficinas/Kapital/1.png" class="bg-image lazyload" data-alt="The Kapital Group City Place"></div>
                            </figure>
                        </div>
                    </div>
                    ...
                    <div class="block block-border-left col-md-12 col-sm-12 block-white" data-block>
                        <div class="block-bottom sg-mb-40px blockStayText">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-22 col-sm-offset-1 text-white">
                                        <div class="visible-xs">
                                            <h1 class="sg-mb-10px">Infotree Global Solutions</h1>
                                        </div>
                                        <div class="hidden-xs">
                                            <h2 class="sg-mb-10px">Infotree Global Solutions</h2>
                                            <p class="text-white sg-mb-20px hidden-xs">

                                        La atención a las necesidades de nuestros clientes ha permitido que Infotree se convierta en el socio de referencia para muchas de las organizaciones líderes en el mundo.
                                            </p>
                                        </div>
                                        <a href="InfotreeGlobalSolutions.php"  class="stayExploreMoreCTA btn btn-default-transparent btn-block-sm text-uppercase margin-right-xs-px">
                                            MÁS INFORMACIÓN
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="block-visuals">
                            <figure class="block-cover-img">
                                <div data-bgset="https://demo.cityplacecr.com/images/Oficinas/Infrotree/1.jpg" class="bg-image lazyload" data-alt="Infotree Global Solutions City Place"></div>
                            </figure>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xs-24 sg-mb-50px">
                    <ul class="sub-nav--search">
                        <li>
                            <a href="#"  class="active" data-toggle="filter-search" data-filter="all">
                                All (<span id="srch_count_all">0</span>)
                            </a>
                        </li>
                        <li>
                            <a href="#"  data-toggle="filter-search" data-filter="src__shops">
                                Shop (<span id="srch_count_shop">0</span>)
                            </a>
                        </li>
                        <li>
                            <a href="#"  data-toggle="filter-search" data-filter="src__offers">
                                Offers (<span id="srch_count_offer">0</span>)
                            </a>
                        </li>
                        <li>
                            <a href="#"  data-toggle="filter-search" data-filter="src__events">
            ...
            <div class="display-table-cell col-middle">
                <div class="modal-custom-container__box text-center animated fadeInUp">
                    ...
                    <div class="step-1">
                        ...
                        <p class="text-muted">
                            <a  href="about-us/privacy-policies.html">Privacy Policy</a>
                        </p>
                    </div>
...
<!-- Mirrored from thedubaimall.com/en/stay by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Apr 2022 23:30:52 GMT -->
