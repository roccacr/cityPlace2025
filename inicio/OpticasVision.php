                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="https://demo.cityplacecr.com/images/Comercio/Opticas/logo.png" alt="   Ópticas Visión City Place" class="sg-mb-30px sg-hero-logo invert" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                                Ópticas Visión con más de 60 años de experiencia y más de 140 sucursales para su mayor comodidad.</p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel:+5062243 9000" class="text-white plusicon_ar topLinkGold">+506 2243 9000</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:servicioalcliente@vision.co.cr" class="text-white topLinkGold">servicioalcliente@vision.co.cr</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel:+5062243 9000" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 2243 90004</span>
                                            </a>
                                            <a href="tel:+5062243 9000" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 2243 9000</span>
                                            </a>
                                            <a href="mailto:servicioalcliente@vision.co.cr" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-envelope"></span>
                                                <span>servicioalcliente@vision.co.cr</span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="https://demo.cityplacecr.com/images/Comercio/Opticas/banner.webp" data-alt="Ópticas Visión City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="https://demo.cityplacecr.com/images/Comercio/Opticas/banner.webp" data-alt="Ópticas Visión City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="https://demo.cityplacecr.com/images/Comercio/Opticas/banner.webp" data-alt="Ópticas Visión City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="https://demo.cityplacecr.com/images/Comercio/Opticas/banner.webp" data-alt="Ópticas Visión City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Ópticas Visión</h5>

                                        <h2 class="sg-mb-20px">Feliz con mis nuevos lentes con tecnología Crizal</h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            <p class="clearfix">
                                                ¿Cuál de estos anteojos irían mejor con su outfit esta semana?
                                            </p>

                                            <p>
                                                <a href="https://www.opticasvision.co.cr/" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Ver más</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Comercio/Opticas/3.jpg" class="bg-image lazyload" data-alt="Ópticas Visión City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Comercio/Opticas/4.jpg" class="bg-image lazyload" data-alt="Ópticas Visión City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Comercio/Opticas/2.jpg" class="bg-image lazyload" data-alt="Ópticas Visión City Place"></div>
                                    </figure>
                                </div>
