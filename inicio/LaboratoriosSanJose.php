    ...
    <div class="site-content stay-page">
        <div class="site-sections">
                            ...
                            <div class="row">
                                <div class="col-sm-22 col-sm-offset-1">
                                    <ul class="breadcrumb breadcrumb--reverse sg-mt-20px">
                                        ...
                                        <li>
                                            <span class="arrow"></span>
                                            Laboratorios Clínicos San José
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="block-slide">
                            <div class="block-bottom sg-mb-90px sg-mb-20px-sm">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <!-- LOGO LABORATORIO SAN JOSE -->
                                            <img src="https://demo.cityplacecr.com/images/Salud/LaboratorioSanJose/logo.png" alt="Bvlgari" class="sg-mb-30px sg-hero-logo invert" />
                                            <div class="solid-line hidden-xs sg-mb-20px"></div>
                                        </div>
                                    </div>
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <!-- DESCRIPCION LABORATORIO SAN JOSE -->
                                            <p class="text-white">
                                                Somos una cadena de laboratorios clínicos que brindamos servicios de salud de la más alta calidad, mediante un equipo de profesionales altamente capacitados y comprometidos, distinguiéndonos por la atención y respeto a nuestros pacientes.</p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel:+506 6063 6363" class="text-white plusicon_ar topLinkGold">+506 6063 6363</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:servicioalcliente@laboratoriosanjose.com" class="text-white topLinkGold">servicioalcliente@laboratoriosanjose.com</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel:+506 6063 6363" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 6063 6363</span>
                                            </a>
                                            <a href="tel:+506 6063 6363" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 6063 6363</span>
                                            </a>
                                            <a href="mailto:servicioalcliente@laboratoriosanjose.com" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-envelope"></span>
                                                <span>servicioalcliente@laboratoriosanjose.com</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="block-visuals">
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="https://demo.cityplacecr.com/images/Salud/LaboratorioSanJose/banner.png" data-alt="Laboratorios San Jose City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="https://demo.cityplacecr.com/images/Salud/LaboratorioSanJose/banner.png" data-alt="Laboratorios San Jose City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="https://demo.cityplacecr.com/images/Salud/LaboratorioSanJose/banner.png" data-alt="Laboratorios San Jose City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="https://demo.cityplacecr.com/images/Salud/LaboratorioSanJose/banner.png" data-alt="Laboratorios San Jose City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
            ...
            <div class="block-container block-container-gold">
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Laboratorios Clínicos San José</h5>
                                        <h2 class="sg-mb-20px">AUTO-Pruebas COVID-19 </h2>
                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            <p class="clearfix">
                                                La responsabilidad de cuidarse siempre ha sido nuestra, por eso ahora te ofrecemos las pruebas COVID-19 para tomarte vos misma(o) la muestra
                                                ¡PREVENIR es la mejor forma de evitar el contagio!
                                            </p>
                                            <p>
                                                <a href="http://www.laboratoriosanjose.com/" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">MÁS INFORMACIÓN
                                                </a>
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Salud/LaboratorioSanJose/1.png" class="bg-image lazyload" data-alt="https://www.facebook.com/Laboratoriosanjose/photos/5423351981032712"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Salud/LaboratorioSanJose/2.png" class="bg-image lazyload" data-alt="https://www.facebook.com/Laboratoriosanjose/photos/5415497841818126"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Salud/LaboratorioSanJose/3.png" class="bg-image lazyload" data-alt="https://www.facebook.com/Laboratoriosanjose/photos/5420697404631503"></div>
                                    </figure>
                                </div>
                ...
                <div class="block-container">
                    <div class="block-abs">
                        <div class="block block-border-right col-md-14 col-sm-12" data-block> </div>
                        <div class="block-padding" data-block-height data-xs="2" data-sm="1" data-md="1" data-lg="1"></div>
                    </div>
