                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="./images/Restaurantes/callejonmexicano/logocallejonmexicano.png" alt="Bvlgari" class="sg-mb-30px sg-hero-logo invert" style="min-height: auto;" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                            Disfrutá de un restaurante 100% de origen mexicano, lleno de sabor y cultura. Desde tacos y gringas hasta el exquisito pan de muerto y refrescantes margaritas.
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    ...
                                                    <span><img src="images/NUEVOS/phone.png" style="width: 20px;"></span>
                                                        <a href="tel: +506 4035-3111" class="text-white plusicon_ar topLinkGold">+506 7297 6477</a>
                                                    </p>
                                                </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="./images/Restaurantes/callejonmexicano/externa.jpg" data-alt="El Callejón Mexicano"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="./images/Restaurantes/callejonmexicano/externa.jpg" data-alt="El Callejón Mexicano"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="./images/Restaurantes/callejonmexicano/externa.jpg" data-alt="El Callejón Mexicano"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="./images/Restaurantes/callejonmexicano/externa.jpg" data-alt="El Callejón Mexicano"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">El Callejón Mexicano</h5>

                                        <h2 class="sg-mb-20px">¡Auténtica Comida Mexicana!</h2>
                                        ...
                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            ...
                                            <p>
                                                <a href="https://www.facebook.com/elcallejonmexicano.cr" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Facebook</a>
                                            </p>
                                            <p>
                                                <a href="https://www.instagram.com/elcallejonmexicano_cr/" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Instagram</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="./images/Restaurantes/callejonmexicano/1.jpg" class="bg-image lazyload" data-alt="El Callejón Mexicano"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="./images/Restaurantes/callejonmexicano/2.jpg" class="bg-image lazyload" data-alt="El Callejón Mexicano"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="./images/Restaurantes/callejonmexicano/3.jpg" class="bg-image lazyload" data-alt="El Callejón Mexicano"></div>
                                    </figure>
                                </div>
