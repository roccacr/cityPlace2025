                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="images/NUEVOS/shibuya/shibuyalogo.png" alt="Shibuya City Place" class="sg-mb-30px sg-hero-logo invert" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">La cocina Nikkei es un baile armonioso de ingredientes y técnicas peruanas y japonesas. Es un viaje culinario que nace de la inmigración y la mezcla de culturas: la increíble fusión de lo mejor de Perú y Japón en un solo menú.</p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel:+506 7290 0754" class="text-white plusicon_ar topLinkGold">+506 7290 0754</a>
                                                    </p>
                                                </div>
                                                ...
                                                <!-- <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:guacamolecr@gmail.com" class="text-white topLinkGold">guacamolecr@gmail.com</a>
                                                    </p>
                                                </div> -->
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel: +506 7290 0754" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 7290 0754</span>
                                            </a>
                                            <a href="tel:+506 7290 0754" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 7290 0754</span>
                                            </a>
                                            <!-- <a href="mailto:guacamolecr@gmail.com" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-envelope"></span>
                                                <span>guacamolecr@gmail.com</span>
                                            </a> -->
                                        </div>
                                    </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="images/NUEVOS/shibuya/1.jpg" data-alt="Shibuya City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="images/NUEVOS/shibuya/1.jpg" data-alt="Shibuya City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="images/NUEVOS/shibuya/1.jpg" data-alt="Shibuya City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="images/NUEVOS/shibuya/1.jpg" data-alt="Shibuya City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="block block-border-right col-md-10 col-sm-12 block-white" data-block>
                            <div class="block-content">
                                ...
                                <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Shibuya</h5>

                                        <h2 class="sg-mb-20px">Comida Nikkei</h2>
                                        ...
                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            ...
                                            <p>
                                                <a href="https://pub.foliomobile.com/NMaycWayzUSYCw_RM2JLHw/?m=insta " class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Menú Digital</a>
                                            </p>
                                            <!-- <p>
                                                <a href=" https://www.instagram.com/TapHouseCR/ " class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Instagram</a>
                                            </p> -->
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/NUEVOS/shibuya/2.jpg" class="bg-image lazyload" data-alt="Shibuya City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/NUEVOS/shibuya/5.jpg" class="bg-image lazyload" data-alt="Shibuya City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/NUEVOS/shibuya/4.jpg" class="bg-image lazyload" data-alt="Shibuya City Place"></div>
                                    </figure>
                                </div>
