                            ...
                            <div class="block-bottom sg-mb-90px sg-mb-20px-sm">
                                <div class="container-fluid">
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel:+506 4000 5171" class="text-white plusicon_ar topLinkGold">+506 4000 5171</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel:+506 4000 5171" class="btn btn-default-transparent text-uppercase visible-xs">
