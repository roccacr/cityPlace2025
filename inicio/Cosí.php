                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="images/Restaurantes/cosi/logo1.png" alt="Cosi City Place" class="sg-mb-30px sg-hero-logo invert" style="min-height:85px"  />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                                Cadena de restaurantes de Estados Unidos del segmento Fast-Casual (rápido-informal). Diseñado para ofrecer una experiencia gastronómica fresca y nueva.</p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel: +506 7171 9838" class="text-white plusicon_ar topLinkGold">+506 7171 9838</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:info@cosi.cr" class="text-white topLinkGold">info@cosi.cr</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel: +506 7171 9838" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 7171 9838</span>
                                            </a>
                                            <a href="tel: +506 7171 9838" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 7171 9838</span>
                                            </a>
                                            <a href="mailto:info@cosi.cr" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-envelope"></span>
                                                <span>info@cosi.cr</span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="images/banners-categorias/cosi-cosi.jpg" data-alt="Cosi City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="images/banners-categorias/cosi-cosi.jpg" data-alt="Cosi City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="images/banners-categorias/cosi-cosi.jpg" data-alt="Cosi City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="images/banners-categorias/cosi-cosi.jpg" data-alt="Cosi City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">COSÌ</h5>

                                        <h2 class="sg-mb-20px">¡No te quedés sin probar nuestro sabor inigualable! </h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            <p class="clearfix">

                                                Recordá que podés ordenar a través de la plataforma de Uber Eats y adquirir promociones tan excepcionales como el sabor de cada uno de nuestros platillos.
                                                Aprovechá esta promo EXCLUSIVA DE UBER PASS ¡Echale un vistazo!
                                            </p>
                                            <p>
                                                <a href="http://cosi.cr/cosi/" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Visita Página</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/Restaurantes/cosi/3.jpg" class="bg-image lazyload" data-alt="Cosi City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/Restaurantes/cosi/4.jpg" class="bg-image lazyload" data-alt="Cosi City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/Restaurantes/cosi/5.jpg" class="bg-image lazyload" data-alt="Cosi City Place"></div>
                                    </figure>
                                </div>
