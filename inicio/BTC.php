                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="images/banners-categorias/logo-BCT.png" alt=" Banco BCT S.A. City Place" class="sg-mb-30px sg-hero-logo invert" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                                ...
                                                Somos soluciones financieras integrales, un servicio altamente personalizado y altos niveles de eficiencia, con diversidad de productos</p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel:+5062212 8000" class="text-white plusicon_ar topLinkGold">+506 2212 8000</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:
                                                                info@corporacionbct.com" class="text-white topLinkGold">
                                                            info@corporacionbct.com</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel:+5062212 8000" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 2212 8000</span>
                                            </a>
                                            <a href="tel:+5062212 8000" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 2212 8000</span>
                                            ...
                                            <a href="mailto:
                                                                                                    info@corporacionbct.com" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-envelope"></span>
                                                <span>
                                                    info@corporacionbct.com</span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="images/banners-categorias/banner-BTC.webp" data-alt="Banco BCT S.A. City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="images/banners-categorias/banner-BTC.webp" data-alt="Banco BCT S.A. City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="images/banners-categorias/banner-BTC.webp" data-alt="Banco BCT S.A. City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="images/banners-categorias/banner-BTC.webp" data-alt="Banco BCT S.A. City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Banco BCT S.A.</h5>

                                        <h2 class="sg-mb-20px">Rápido, fácil y sin contacto.​​ </h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            <p class="clearfix">
                                                En Banco BCT le ofrecemos excelentes opciones de financiamiento disponibles para usted.​
                                            </p>

                                            <p>
                                                <a href="https://www.bancobct.com/?fbclid=IwAR0er12Mvb7ilCVNbhlHo1eKvC6Rs5HHzhloRT993mIPGwPuAsvSuJCIDqI" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Ver Más</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/2-BCT.jpg" class="bg-image lazyload" data-alt="Banco BCT S.A. City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/3-BCT.jpg" class="bg-image lazyload" data-alt="Banco BCT S.A. City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/4-BCT.jpg" class="bg-image lazyload" data-alt="Banco BCT S.A. City Place"></div>
                                    </figure>
                                </div>
