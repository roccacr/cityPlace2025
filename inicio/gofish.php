                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="./images/Restaurantes/gofish/logogofish.png" alt="Bvlgari" class="sg-mb-30px sg-hero-logo invert" style="min-height: auto;" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                            Go fish es la nueva experiencia culinaria de mariscos. Donde vivirás una experiencia única e innovadora en cada uno de sus platillos que rompen las reglas.
                                            </p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    ...
                                                    <span><img src="images/NUEVOS/phone.png" style="width: 20px;"></span>
                                                        <a href="tel: +506 4035-3111" class="text-white plusicon_ar topLinkGold">+506 2101 8935</a>
                                                    </p>
                                                </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="./images/Restaurantes/gofish/1.jpg" data-alt="Go Fish"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="./images/Restaurantes/gofish/1.jpg" data-alt="Go Fish"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="./images/Restaurantes/gofish/1.jpg" data-alt="Go Fish"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="./images/Restaurantes/gofish/1.jpg" data-alt="Go Fish"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Go Fish</h5>

                                        <h2 class="sg-mb-20px">¡Más que más mariscos!</h2>
                                        ...
                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            ...
                                            <p>
                                                <a href="https://www.facebook.com/GoFishSeafoodCo" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Facebook</a>
                                            </p>
                                            <p>
                                                <a href="https://www.instagram.com/gofish_seafoodco/" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Instagram</a>
                                            </p>
                                            <p>
                                                <a href="https://tr.ee/xt_hcSAlcZ" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Menu Digital</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="./images/Restaurantes/gofish/externa.jpg" class="bg-image lazyload" data-alt="The Yard"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="./images/Restaurantes/gofish/2.jpg" class="bg-image lazyload" data-alt="The Yard"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="./images/Restaurantes/gofish/3.jpg" class="bg-image lazyload" data-alt="The Yard"></div>
                                    </figure>
                                </div>
