                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="images/banners-categorias/logo-chic4.png" alt="Chic4Pets City Place" class="sg-mb-30px sg-hero-logo invert" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                                Chic4Pets, la nueva boutique para mascotas de Costa Rica, abrió sus puertas en Octubre 2021 en el centro comercial City Place en Santa Ana, para chinear a tus perros y gatos con accesorios de diseño, elegancia y diversión.</p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel:+5062663 6666" class="text-white plusicon_ar topLinkGold">+506 2663 6666</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:chic4pets@gmail.com" class="text-white topLinkGold">chic4pets@gmail.com</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel:+5062663 6666" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 2663 6666</span>
                                            </a>
                                            <a href="tel:+5062663 6666" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 2663 6666</span>
                                            </a>
                                            <a href="mailto:chic4pets@gmail.com" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-envelope"></span>
                                                <span>chic4pets@gmail.com</span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="images/banners-categorias/1-chic4.jpg" data-alt="Chic4Pets City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="images/banners-categorias/1-chic4.jpg" data-alt="Chic4Pets City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="images/banners-categorias/1-chic4.jpg" data-alt="Chic4Pets City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="images/banners-categorias/1-chic4.jpg" data-alt="Chic4Pets City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Chic4Pets</h5>

                                        <h2 class="sg-mb-20px">¿Tu perrito ocupa una capa para pasear sin mojarse?</h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            <p class="clearfix">
                                                Nuestros diferentes impermeables están fabricados todos con telas, diseños y confección de alta calidad para que tu perrito se sienta súper cómodo.
                                            </p>
                                            <p>
                                                <a href="https://www.facebook.com/Chic4Pets/?ref=page_internal" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Ver Más</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/3-chic4.jpg" class="bg-image lazyload" data-alt="Chic4Pets City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/2-chic4.jpg" class="bg-image lazyload" data-alt="Chic4Pets City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/4-chic4.jpg" class="bg-image lazyload" data-alt="Chic4Pets City Place"></div>
                                    </figure>
                                </div>
