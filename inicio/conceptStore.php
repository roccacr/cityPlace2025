...
<div class="site">
    <img src="http://mena-gmtdmp.mookie1.com/t/v2/activity?tagid=V2_236250&amp;src.rand=[timestamp]" style="display:none;" />
                                ...
                                <div class="col-sm-22 col-sm-offset-1">
                                    ...
                                    <ul class="breadcrumb breadcrumb--reverse sg-mt-20px">
                                        ...
                                        <li>
                                            ...
                                            <a href="../store-directory.php">Fashion</a>
                                        </li>
                                        <li>
                                            <span class="arrow"></span>
                                            The Concept Store
                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="images/Comercio/conceptstore/logo.png" alt="The Concept Store City Place" class="sg-mb-30px sg-hero-logo invert" />
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel: " class="text-white plusicon_ar topLinkGold"></a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:" class="text-white topLinkGold"></a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel: " class="btn btn-default-transparent text-uppercase visible-xs">
                                            ...
                                            <a href="mailto:" class="btn btn-default-transparent text-uppercase visible-xs">
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="images/banners-categorias/145-conceptstore.png" data-alt="The Concept Store City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="images/banners-categorias/145-conceptstore.png" data-alt="The Concept Store City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="images/banners-categorias/145-conceptstore.png" data-alt="The Concept Store City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="images/banners-categorias/145-conceptstore.png" data-alt="The Concept Store City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">The Concept Store</h5>

                                        <h2 class="sg-mb-20px">Wear it and own it </h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            <p class="clearfix">
                                                Your style should be an expression of who you are. Have fun with new designs available at tiempo real
                                            </p>
                                            <p><strong>To book an appointment, please call:</strong></p>
                                            <p>
                                                <a href="tel:+971-4-330-8834" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">+971-4-330-8834</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/1-conceptstore.jpg" class="bg-image lazyload" data-alt="The Concept Store City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/144-conceptstore.png" class="bg-image lazyload" data-alt="The Concept Store City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/146-conceptstore.png" class="bg-image lazyload" data-alt="The Concept Store City Place"></div>
                                    </figure>
                                </div>
