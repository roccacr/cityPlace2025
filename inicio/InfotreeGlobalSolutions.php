                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="https://demo.cityplacecr.com/images/Oficinas/Infrotree/logo1.png" alt=" Infotree Global Solutions City Place" class="sg-mb-30px sg-hero-logo invert" style="min-height:85px" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                                Hemos ayudado a miles de empleados a encontrar el trabajo de sus sueños en los 5 continentes de todo el mundo</p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:info@infotreeglobal.com" class="text-white topLinkGold">info@infotreeglobal.com</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <a href="mailto: info@infotreeglobal.com" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-envelope"></span>
                                                <span> info@infotreeglobal.com</span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="https://demo.cityplacecr.com/images/Oficinas/Infrotree/5.jpg" data-alt="Infotree Global Solutions City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="https://demo.cityplacecr.com/images/Oficinas/Infrotree/5.jpg" data-alt="Infotree Global Solutions City Place Global Solutions City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="https://demo.cityplacecr.com/images/Oficinas/Infrotree/5.jpg" data-alt="Infotree Global Solutions City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="https://demo.cityplacecr.com/images/Oficinas/Infrotree/5.jpg" data-alt="Infotree Global Solutions City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;"> Infotree Global Solutions</h5>

                                        <h2 class="sg-mb-20px">Hablemos de su proyecto ahora</h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            <p class="clearfix">
                                            Desde un solo consultor hasta un equipo completo, encontraremos la combinación perfecta para sus necesidades de personal.

                                            </p>
                                           
                                            <p>
                                                <a href="https://www.infotreeglobal.com/" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Visita Página</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Oficinas/Infrotree/3.jpg" class="bg-image lazyload" data-alt="Infotree Global Solutions City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Oficinas/Infrotree/4.jpg" class="bg-image lazyload" data-alt="Infotree Global Solutions City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Oficinas/Infrotree/2.jpg" class="bg-image lazyload" data-alt="Infotree Global Solutions City Place"></div>
                                    </figure>
                                </div>
