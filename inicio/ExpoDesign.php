                        ...
                        <div class="block-slide">
                            <div class="block-bottom sg-mb-90px sg-mb-20px-sm">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <img src="https://demo.cityplacecr.com/images/logos/22.png" alt="Expo Design City Place" class="sg-mb-30px sg-hero-logo invert" style="min-height:85px" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                            Estética elegante y combinaciones sofisticadas, permiten múltiples posibilidades de composición dentro de cada modelo de nuestras series, con toda la tecnología aplicada en su producción.</p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:info@expodesigncr.com" class="text-white topLinkGold">info@expodesigncr.com
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <a href="tel:+ 506 4035 5000" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+ 506 4035 5000</span>
                                            </a>
                                            <a href="mailto:info@expodesigncr.com

" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-envelope"></span>
                                                <span>info@expodesigncr.com
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="https://demo.cityplacecr.com/images/Comercio/ExpoDesign/banner1.png" data-alt="Expo Design City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="https://demo.cityplacecr.com/images/Comercio/ExpoDesign/banner1.png" data-alt="Expo Design City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="https://demo.cityplacecr.com/images/Comercio/ExpoDesign/banner1.png" data-alt="Expo Design City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="https://demo.cityplacecr.com/images/Comercio/ExpoDesign/banner1.png" data-alt="Expo Design City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Expo Design</h5>

                                        <h2 class="sg-mb-20px">Múltiples acabados <br> de lujo </h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            <p class="clearfix">
                                                Revolucionando el mercado mobiliario, acabado de cocina, closet y sobres. 
                                            </p>
                                            <p>
                                                <a href="https://expodesigncr.com/" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Visite Sitio Web</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Comercio/ExpoDesign/4.png" class="bg-image lazyload" data-alt="Expo Design City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Comercio/ExpoDesign/5.png" class="bg-image lazyload" data-alt="Expo Design City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Comercio/ExpoDesign/6.png" class="bg-image lazyload" data-alt="Expo Design City Place"></div>
                                    </figure>
                                </div>
