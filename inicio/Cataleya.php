                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="images/NUEVOS/cataleya/cataleyalogo.png" width="15%" alt="Cataleya City Place" class="sg-mb-30px invert" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">Un espacio instagrameable con variedad de platillos de desayuno, almuerzo, café, repostería, cena y coctéles.</p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel:+506 2100-1088" class="text-white plusicon_ar topLinkGold">+506 2100-1088</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel: +506 2100-1088" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 2100-1088</span>
                                            </a>
                                            <a href="tel:+506 2100-1088" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 2100-1088</span>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="images/NUEVOS/cataleya/1.jpg" data-alt="Shibuya City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="images/NUEVOS/cataleya/1.jpg" data-alt="Shibuya City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="images/NUEVOS/cataleya/1.jpg" data-alt="Shibuya City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="images/NUEVOS/cataleya/1.jpg" data-alt="Shibuya City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="block block-border-right col-md-10 col-sm-12 block-white" data-block>
                            <div class="block-content">
                                ...
                                <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Cataleya</h5>

                                        <h2 class="sg-mb-20px">Bistro Lounge</h2>
                                        ...
                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            ...
                                            <p>
                                                <a href="https://www.instagram.com/cataleyacoffeeshop/?hl=es" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Instagram</a>
                                            </p>
                                            <!-- <p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/NUEVOS/cataleya/2.jpg" class="bg-image lazyload" data-alt="Cataleya City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/NUEVOS/cataleya/3.jpg" class="bg-image lazyload" data-alt="Cataleya City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/NUEVOS/cataleya/4.jpg" class="bg-image lazyload" data-alt="Cataleya City Place"></div>
                                    </figure>
                                </div>
