                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="https://demo.cityplacecr.com/images/Comercio/conceptstore/logo.png" alt="Concept Store City Place" class="sg-mb-30px sg-hero-logo invert" style="min-height:95px" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                                Talentos para descubrir la magia.</p>
                                        </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="https://demo.cityplacecr.com/images/tiendas/concept11.png" data-alt="Concept Store City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="https://demo.cityplacecr.com/images/tiendas/concept11.png" data-alt="Concept Store City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="https://demo.cityplacecr.com/images/tiendas/concept11.png" data-alt="Concept Store City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="https://demo.cityplacecr.com/images/tiendas/concept11.png" data-alt="Concept Store City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        ...
                                        <h2 class="sg-mb-20px">Talentos para descubrir la magia. </h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            <p><strong>Horario:</strong></p>
                                            <p class="clearfix">
                                                Lun-Sab: 10:00 am- 8:00 pm <br>
                                                Domingo: 10:00 am- 4:00 pm
                                            </p>

                                            <p>
                                                <a href="https://www.instagram.com/theconceptcr/" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Más información</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/tiendas/concept111.jpg" class="bg-image lazyload" data-alt="Concept Store City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Comercio/conceptstore/1.jpg" class="bg-image lazyload" data-alt="Concept Store City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Comercio/conceptstore/2.jpg" class="bg-image lazyload" data-alt="Concept Store City Place"></div>
                                    </figure>
                                </div>
