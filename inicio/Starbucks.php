                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="images/Restaurantes/starbucks/logostarbucks.png" alt="City Place" class="sg-mb-30px sg-hero-logo invert" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">Disfrutá de una amplia variedad de bebidas, perfectas tanto para los amantes del café como para quienes buscan nuevas experiencias llenas de sabor.</p>
                                        </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="images/Restaurantes/starbucks/1.jpg" data-alt=" City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="images/Restaurantes/starbucks/1.jpg" data-alt=" City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="images/Restaurantes/starbucks/1.jpg" data-alt=" City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="images/Restaurantes/starbucks/1.jpg" data-alt=" City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="block-abs">
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Starbucks</h5>

                                        <h2 class="sg-mb-20px">¡Un taza de café que nos une!</h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                        <p>
                                                <a href="https://www.facebook.com/StarbucksCostaRica" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Facebook</a>
                                            </p>
                                            <p>
                                                <a href="https://www.instagram.com/starbucks_cr/" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Instagram</a>
                                            </p>
                                            <p>
                                                <a href="https://lac.starbucksglobalacademy.com/es/explore/" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Sitio Web</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/Restaurantes/starbucks/2.jpg" class="bg-image lazyload" data-alt=" City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/Restaurantes/starbucks/3.jpg" class="bg-image lazyload" data-alt=" City Place"></div>
                                    </figure>
                                </div>
