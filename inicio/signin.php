    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          <h2 class="text-center">TU Próxima oficina en City Place</h2>
          <h4 class="text-center">Envíanos tus datos para recibir más información sobre nuestras oficinas disponibles.</h4>
          ...
          <br>
          <button type="submit" onclick="location.href='index.php';" class=" btn-main text-center volver">Volver a Página Principal</button>
        </div>
      </div>
    </div>
  </div>
...
Toast.fire({
  ...
  $("#myForm").submit(function(e) {
    ...
    const espacioInput = document.getElementById('espacio');
      ...
      e.preventDefault();
      $.ajax({
        url: "https://hooks.zapier.com/hooks/catch/5214118/bw4pijb/",
        type: "post",
