...
<section class="site-section">
        <!-- @view-panel -->
        <div class="view-panel view-panel--xs">
          <div class="view-panel__abs">

            <div class="view-panel__top hidden-xs">
              <div class="container">
                <div class="row">
                  <div class="col-sm-24">
            ...
            <div class="display-table">
              <div class="display-table-cell col-middle">
                <div class="container">
                  <div class="row">
                    <div class="col-xs-24">
                      <h1 class="text-center text-white" id="plan-your-visit-text-h1">Contacto</h1>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="view-panel__visual">
            <div class="bg-image lazyload" data-bgset="images/banners-categorias/contacto-contacto.webp  [(max-width: 766px] | images/banners-categorias/contacto-contacto.webp  [(max-width: 1022px] | images/banners-categorias/contacto-contacto.webp" data-alt="Plan Your Visit"></div>
          </div>
        </div>
      </section>
...
<div class="col-xs-24">
      <div class="visible-xs">
          <h2 class="text-center sg-mt-40px sg-mb-25px">Información</h2>
      </div>
      <div class="hidden-xs">
        
                <h2 class="text-center sg-mt-40px">Información</h2>

                <p class="text-center sg-mt-40px">HORARIO:24/7 / Validar horario de cada local comercial <br><br>

DIRECCIÓN:200m norte de la Cruz Roja de Santa Ana. Santa Ana, San José.
Sobre Radial Santa - Belén.<br><br>

TELÉFONO: 4035-5000 <br><br>

CORREO:info@cityplacecr.com<br><br>
      ...
      <section class="site-section hidden-xs">
        <!-- @view-panel -->
        <div class="view-panel">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15719.916915825432!2d-84.1897499!3d9.935686!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xc2928c87ad3a7f6f!2sCity%20Place!5e0!3m2!1ses-419!2scr!4v1654017583242!5m2!1ses-419!2scr"  style="border: 0; width: 100%; height: 100%; min-height: inherit; position: absolute; top:0; right:0; bottom:0; left:0;" allowfullscreen></iframe>
        
        </div>
      </section>

    </div>
    <div class="container sg-mt-30px visible-xs">
      <div class="site-collapse-menu site-collapse-menu--inpage sg-mb-50px">
  <nav>
    <ul class="js--accordion" id="gettingHere-mobile-Nav">
      <li class="site-collapse-menu-item" data-index="metro">
        <a class="site-collapse-menu__level-1 collapsed" aria-expanded="false" >
          <strong>Información</strong>
        </a>
        <div class="site-collapse-menu__content">
            <div class="sg-mb-25px sg-mt-5px metroContent">
...
CORREO:info@cityplacecr.com<br><br>
      ...
      <li class="site-collapse-menu-item" data-index="bus">
        <a class="site-collapse-menu__level-1 collapsed" aria-expanded="false" >
          <strong>Mapa</strong>
        </a>
        <div class="site-collapse-menu__content">
          <div class="sg-mb-25px busContent">
          <div class="view-panel">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15719.916915825432!2d-84.1897499!3d9.935686!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xc2928c87ad3a7f6f!2sCity%20Place!5e0!3m2!1ses-419!2scr!4v1654017583242!5m2!1ses-419!2scr"  style="border: 0; width: 100%; height: 100%; min-height: inherit; position: absolute; top:0; right:0; bottom:0; left:0;" allowfullscreen></iframe>
      ...
      <li class="site-collapse-menu-item" data-index="car">
        <a class="site-collapse-menu__level-1 collapsed" aria-expanded="false">
          <strong>Waze</strong>
        </a>
          <div class="content collapse" id="tcm-3" aria-expanded="false">
            <div class="sg-mb-10px content-car-container">
      ...
      <li class="site-collapse-menu-item" data-index="taxi-careem-uber">
        <a class="site-collapse-menu__level-1 collapsed" aria-expanded="false">
          <strong>Formulario</strong>
        </a>
        <div class="content collapse" id="tcm-4" aria-expanded="false">
          <div class="sg-mb-10px taxi-careem-uber-Content"></div>
        </div>
      </li>
      <li class="site-collapse-menu-item" data-index="coach">
        <a class="site-collapse-menu__level-1 collapsed" aria-expanded="false">
      ...
      <li class="site-collapse-menu-item" data-index="coach">
        <a class="site-collapse-menu__level-1 collapsed" aria-expanded="false">
          <strong>Locales Disponibles</strong>
        </a>
        <div class="content collapse" id="tcm-4" aria-expanded="false">
