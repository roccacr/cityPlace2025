                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="https://demo.cityplacecr.com/images/Comercio/StudioCinemas/logo.png" alt="Studios Cinemas City Place" class="sg-mb-30px sg-hero-logo invert" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                                Somos un cine independiente que te brinda una experiencia distinta y acogedora.
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel:+506 4035 3105" class="text-white plusicon_ar topLinkGold">+506 4035 3105</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:info@studiocinemascr.com" class="text-white topLinkGold">
                                                            info@studiocinemascr.com</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel:+506 4035 3105" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 4035 3105</span>
                                            </a>
                                            <a href="tel:+506 4035 3105" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 4035 3105</span>
                                            </a>
                                            <a href="mailto:info@studiocinemascr.com" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-envelope"></span>
                                                <span>info@studiocinemascr.com</span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="https://demo.cityplacecr.com/images/Comercio/StudioCinemas/bannergeneral.webp" data-alt="Studios Cinemas City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="https://demo.cityplacecr.com/images/Comercio/StudioCinemas/bannergeneral.webp" data-alt="Studios Cinemas City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="https://demo.cityplacecr.com/images/Comercio/StudioCinemas/bannergeneral.webp" data-alt="Studios Cinemas City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="https://demo.cityplacecr.com/images/Comercio/StudioCinemas/bannergeneral.webp" data-alt="Studios Cinemas City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                ...
                <div class="block-container">
                    <div class="block-abs">
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Studios Cinemas</h5>

                                        <h2 class="sg-mb-20px">Viví el cine</h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">

                                            <p><strong>Horario:</strong></p>
                                            <p class="clearfix">
                                                L-V 12am a 9pm / S-D 12am a 9pm

                                            </p>

                                            <p>
                                                <a href="https://www.studiocinemascr.com/" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Compra tus tiquetes</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">


                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Comercio/StudioCinemas/6.png" class="bg-image lazyload" data-alt="Studios Cinemas City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Comercio/StudioCinemas/7.png" class="bg-image lazyload" data-alt="Studios Cinemas City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Comercio/StudioCinemas/8.png" class="bg-image lazyload" data-alt="Studios Cinemas City Place"></div>
                                    </figure>
                                </div>
            ...
            <div class="row">
                <div class="col-xs-24 sg-mb-20px">
                    <div class="panel-card">
                        <article>
                            <figure>
                                <a href="shop/cartier-fashion-avenue.html">
                                    <div class="panel-card__img bg-image lazyload sg-mb-10px" data-bgset="https://dynamicassets.azureedge.net/files/store/elevatedPic/56c184eda3357.png.optimized.jpg" data-alt="Cartier"></div>
                                </a>
                            </figure>
                            <main>
                    ...
                    <div class="panel-card">
                        <article>
                            <figure>
                                <a href="shop/chanel.html">
                                    <div class="panel-card__img bg-image lazyload sg-mb-10px" data-bgset="https://dynamicassets.azureedge.net/uploads/offer/elevatedPic/56e7b4368897e.png.optimized.jpg" data-alt="Chanel"></div>
                                </a>
                            </figure>
                            <main>
                    ...
                    <div class="panel-card">
                        <article>
                            <figure>
                                <a href="shop/christian-louboutin-1.html">
                                    <div class="panel-card__img bg-image lazyload sg-mb-10px" data-bgset="https://dynamicassets.azureedge.net/uploads/offer/elevatedPic3/5b8e24ec14d01.jpg" data-alt="Christian Louboutin"></div>
                                </a>
                            </figure>
                            <main>
                    ...
                    <div class="panel-card">
                        <article>
                            <figure>
                                <a href="shop/graff.html">
                                    <div class="panel-card__img bg-image lazyload sg-mb-10px" data-bgset="https://dynamicassets.azureedge.net/files/store/elevatedPic/56cb06662106d.png.optimized.jpg" data-alt="Graff"></div>
                                </a>
                            </figure>
                            <main>
                    ...
                    <div class="panel-card">
                        <article>
                            <figure>
                                <a href="shop/harry-winston-1.html">
                                    <div class="panel-card__img bg-image lazyload sg-mb-10px" data-bgset="https://dynamicassets.azureedge.net/files/store/elevatedPic/569c9b0097cae.png.optimized.jpg" data-alt="Harry Winston"></div>
                                </a>
                            </figure>
                            <main>
                    ...
                    <div class="panel-card">
                        <article>
                            <figure>
                                <a href="shop/level-shoes.html">
                                    <div class="panel-card__img bg-image lazyload sg-mb-10px" data-bgset="https://dynamicassets.azureedge.net/uploads/offer/elevatedPic3/612e38f171056.jpg" data-alt="Level Shoes"></div>
                                </a>
                            </figure>
                            <main>
                    ...
                    <div class="panel-card">
                        <article>
                            <figure>
                                <a href="shop/symphony.html">
                                    <div class="panel-card__img bg-image lazyload sg-mb-10px" data-bgset="https://dynamicassets.azureedge.net/files/store/elevatedPic/56c1bc7476d2f.png.optimized.jpg" data-alt="Symphony"></div>
                                </a>
                            </figure>
                            <main>
                    ...
                    <div class="panel-card">
                        <article>
                            <figure>
                                <a href="shop/van-cleef.html">
                                    <div class="panel-card__img bg-image lazyload sg-mb-10px" data-bgset="https://dynamicassets.azureedge.net/uploads/offer/elevatedPic3/5e42618b91e37.jpg" data-alt="Van Cleef & Arpels"></div>
                                </a>
                            </figure>
                            <main>
