                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="https://demo.cityplacecr.com/images/Salud/Regenerix/logo1.png" alt="Regenerix City Place" class="sg-mb-30px sg-hero-logo invert" />
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel:+506 7155 7030" class="text-white plusicon_ar topLinkGold">+506 7155 7030</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:store_uae_dubai-mall@bulgari.com" class="text-white topLinkGold">CORREO</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel: +506 7155 7030" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 7155 7030</span>
                                            </a>
                                            <a href="tel:+506 7155 7030" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 7155 7030</span>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="https://demo.cityplacecr.com/images/Salud/Regenerix/banner.png" data-alt="Bulgari"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="https://demo.cityplacecr.com/images/Salud/Regenerix/banner.png" data-alt="Bulgari"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="https://demo.cityplacecr.com/images/Salud/Regenerix/banner.png" data-alt="Bulgari"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="https://demo.cityplacecr.com/images/Salud/Regenerix/banner.png" data-alt="Bulgari"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Dra. Silvia Sibaja Regenerix</h5>

                                        <h2 class="sg-mb-20px">CentroEstético </h2>
                                        ...
                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            ...
                                            <p><strong>Para reservar una cita, por favor llame al:</strong></p>
                                            <p>
                                                <a href="https://www.facebook.com/clinicaregenerix" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">MÁS INFORMACIÓN</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Salud/Regenerix/2.png" class="bg-image lazyload" data-alt="Bulgari"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Salud/Regenerix/1.png" class="bg-image lazyload" data-alt="Bulgari"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Salud/Regenerix/3.png" class="bg-image lazyload" data-alt="Bulgari"></div>
                                    </figure>
                                </div>
