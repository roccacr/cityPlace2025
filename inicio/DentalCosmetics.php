                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="images/banners-categorias/logoo-dentalcosmetic.png" alt=" Dental Cosmetics City Place" class="sg-mb-30px sg-hero-logo invert" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                                La clínica dental está equipada con los equipos más avanzados para apoyar a nuestros dentistas con la última tecnología avanzada y técnicas reconocidas para garantizarle el mejor tratamiento dental y la comodidad que siempre ha deseado.</p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel: +506 2519 9616" class="text-white plusicon_ar topLinkGold">+506 2519 9616</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:
info@dentalcosmeticscr.com" class="text-white topLinkGold">
                                                            info@dentalcosmeticscr.com</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel: +506 2519 9616" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 2519 9616</span>
                                            </a>
                                            <a href="tel: +506 2519 9616" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 2519 9616</span>
                                            ...
                                            <a href="mailto:
info@dentalcosmeticscr.com" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-envelope"></span>
                                                <span>
                                                    info@dentalcosmeticscr.com</span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="images/banners-categorias/banner-dentalcosmetic.jpg" data-alt="Dental Cosmetics City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="images/banners-categorias/banner-dentalcosmetic.jpg" data-alt="Dental Cosmetics City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="images/banners-categorias/banner-dentalcosmetic.jpg" data-alt="Dental Cosmetics City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="images/banners-categorias/banner-dentalcosmetic.jpg" data-alt="Dental Cosmetics City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Dental Cosmetic Costa Rica</h5>

                                        <h2 class="sg-mb-20px">Sonrisas Eternas</h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            <p class="clearfix">
                                                Creando hermosas sonrisas desde 2005
                                            </p>

                                            <p>
                                                <a href="https://dentalcosmeticscr.com/" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Más información</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/1-dentalcosmetic.webp" class="bg-image lazyload" data-alt="Dental Cosmetics City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/2-dentalcosmetic.webp" class="bg-image lazyload" data-alt="Dental Cosmetics City Place"></div>
                                    </figure>
                                </div>
