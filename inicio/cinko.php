                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="images/NUEVOS/cinko/cinkologo.png" alt=" FT Technologies City Place" width="10%" class="sg-mb-30px invert" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                            Con CiNKO, resolver tus necesidades financieras es más fácil que nunca. Ya sea para enviar o recibir remesas, o para realizar pagos entre personas, CiNKO te ofrece la solución perfecta. Con nosotros, puedes recibir remesas en efectivo y retirarlas en cualquier ubicación de MoneyGram, ¡disponible en 44 países! </p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel: +506 4001-5155" class="text-white plusicon_ar topLinkGold">+506 4001-5155</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:letsgo@cinko.io " class="text-white topLinkGold">letsgo@cinko.io </a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel:+506 4001-5155" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 4001-5155</span>
                                            </a>
                                            <a href="tel:+506 4001-5155" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 4001-5155</span>
                                            </a>
                                            <a href="mailto:letsgo@cinko.io " class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-envelope"></span>
                                                <span>letsgo@cinko.io </span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="images/NUEVOS/cinko/1.jpg" data-alt=" FT Technologies City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="images/NUEVOS/cinko/1.jpg" data-alt=" FT Technologies City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="images/NUEVOS/cinko/1.jpg" data-alt=" FT Technologies City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="images/NUEVOS/cinko/1.jpg" data-alt=" FT Technologies City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Cinko</h5>

                                        <h2 class="sg-mb-20px">Soluciones financieras</h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                         

                                            <p>
                                                <a href="https://vamos.cinko.io/" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Visita Página</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/NUEVOS/cinko/2.jpeg" class="bg-image lazyload" data-alt=" FT Technologies City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/NUEVOS/cinko/3.jpeg" class="bg-image lazyload" data-alt=" FT Technologies City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/NUEVOS/cinko/1.jpg" class="bg-image lazyload" data-alt=" FT Technologies City Place"></div>
                                    </figure>
                                </div>
