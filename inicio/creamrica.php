                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="./images/Restaurantes/creamrica/logocreamrica.png" alt="Bvlgari" class="sg-mb-30px sg-hero-logo invert" style="min-height: auto;" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                            Una heladería con un legado familiar, llena de sabor y tradición. Descubrí una gran variedad de sabores únicos, elaborados 100% de manera artesanal.
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    ...
                                                    <span><img src="images/NUEVOS/email.png" style="width: 20px;"></span>
                                                        <a href="mailto:store_uae_dubai-mall@bulgari.com" class="text-white topLinkGold">pedidos@cremrica.com </a>
                                                    </p>
                                                </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="./images/Restaurantes/creamrica/externa.jpg" data-alt="Creamrica"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="./images/Restaurantes/creamrica/externa.jpg" data-alt="Creamrica"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="./images/Restaurantes/creamrica/externa.jpg" data-alt="Creamrica"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="./images/Restaurantes/creamrica/externa.jpg" data-alt="Creamrica"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Creamrica</h5>

                                        <h2 class="sg-mb-20px">¡Deliciosos helados artesanales!</h2>
                                        ...
                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            ...
                                            <p>
                                                <a href="https://www.facebook.com/cremrica1992" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Facebook</a>
                                            </p>
                                            <p>
                                                <a href="https://www.instagram.com/cremrica1992/" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Instagram</a>
                                            </p>
                                            <p>
                                                <a href="https://www.cremrica.com/productos" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Menu Digital</a>
                                            </p>
                                            <p>
                                                <a href="https://www.cremrica.com" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Sitio Web</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="./images/Restaurantes/creamrica/1.jpg" class="bg-image lazyload" data-alt="Creamrica"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="./images/Restaurantes/creamrica/2.jpg" class="bg-image lazyload" data-alt="Creamrica"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="./images/Restaurantes/creamrica/3.jpg" class="bg-image lazyload" data-alt="Creamrica"></div>
                                    </figure>
                                </div>
