                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="https://demo.cityplacecr.com/images/Oficinas/KraftHeinz/logo1.png" alt="  Kraft Heinz City Place" class="sg-mb-30px sg-hero-logo invert" style="min-height: 50px"/>
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                            The Kraft Heinz Company, un productor mundialmente confiable de alimentos deliciosos, ofrece alta calidad, gran sabor y nutrición para todas las ocasiones de comer, ya sea en casa, en restaurantes o para llevar. </p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel:+506 2459 6291" class="text-white plusicon_ar topLinkGold">+506 2459 6291</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:Anthony.barrantes@kraftheinz.com" class="text-white topLinkGold">Anthony.barrantes@kraftheinz.com</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel: +506 2459 6291" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 2459 6291</span>
                                            </a>
                                            <a href="tel: +506 2459 6291" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 2459 6291</span>
                                            </a>
                                            <a href="mailto:Anthony.barrantes@kraftheinz.com" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-envelope"></span>
                                                <span>Anthony.barrantes@kraftheinz.com</span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="https://demo.cityplacecr.com/images/Oficinas/KraftHeinz/banner5.jpg" data-alt="Kraft Heinz City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="https://demo.cityplacecr.com/images/Oficinas/KraftHeinz/banner5.jpg" data-alt="Kraft Heinz City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="https://demo.cityplacecr.com/images/Oficinas/KraftHeinz/banner5.jpg" data-alt="Kraft Heinz City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="https://demo.cityplacecr.com/images/Oficinas/KraftHeinz/banner5.jpg" data-alt="Kraft Heinz City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Kraft Heinz</h5>

                                        <h2 class="sg-mb-20px">Marcas que la gente ama </h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                          
                                            <p>
                                                <a href="https://www.kraftheinzcompany.com/index.html" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Visita Página</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Oficinas/KraftHeinz/banner6.jpg" class="bg-image lazyload" data-alt="Kraft Heinz City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Oficinas/KraftHeinz/banner4.jpg" class="bg-image lazyload" data-alt="Kraft Heinz City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Oficinas/KraftHeinz/banner3.jpg" class="bg-image lazyload" data-alt="Kraft Heinz City Place"></div>
                                    </figure>
                                </div>
