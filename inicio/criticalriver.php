                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="images/NUEVOS/criticalriver/criticalriver-logo.png" alt=" FT Technologies City Place" width="25%" class="sg-mb-30px invert" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                            CriticalRiver es una empresa de consultoría en tecnología digital de confianza, con un historial probado de implementaciones tecnológicas exitosas en áreas como Transformación Digital, Gestión de Experiencia Digital, Compromiso Digital e Ingeniería Digital. Ofrecemos servicios de tecnología digital para CRM, ERP, aplicaciones en la nube, integración, inteligencia empresarial, análisis de datos y soluciones de ingeniería de software, aprovechando nuestras habilidades y capacidades en tecnologías de vanguardia.</p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel: +506 4706-6542" class="text-white plusicon_ar topLinkGold">+506 4706-6542</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:costarica.operations@criticalriver.com " class="text-white topLinkGold">costarica.operations@criticalriver.com </a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel:+506 4706-6542" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 4706-6542</span>
                                            </a>
                                            <a href="tel:+506 4706-6542" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 4706-6542</span>
                                            </a>
                                            <a href="mailto:costarica.operations@criticalriver.com " class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-envelope"></span>
                                                <span>costarica.operations@criticalriver.com </span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="images/NUEVOS/criticalriver/1.jpeg" data-alt=" FT Technologies City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="images/NUEVOS/criticalriver/1.jpeg" data-alt=" FT Technologies City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="images/NUEVOS/criticalriver/1.jpeg" data-alt=" FT Technologies City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="images/NUEVOS/criticalriver/1.jpeg" data-alt=" FT Technologies City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">CriticalRiver</h5>

                                        <h2 class="sg-mb-20px">Consultoría en tecnología</h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                         

                                            <p>
                                                <a href="https://www.criticalriver.com/" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Visita Página</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/NUEVOS/criticalriver/2.jpeg" class="bg-image lazyload" data-alt=" FT Technologies City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/NUEVOS/criticalriver/3.jpeg" class="bg-image lazyload" data-alt=" FT Technologies City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/NUEVOS/criticalriver/4.jpeg" class="bg-image lazyload" data-alt=" FT Technologies City Place"></div>
                                    </figure>
                                </div>
