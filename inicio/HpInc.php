                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="https://demo.cityplacecr.com/images/Oficinas/Hp/logo2.png" alt=" Hp Inc City Place" class="sg-mb-30px sg-hero-logo invert" style="min-height:85px; width:10%"/>
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                            HP Inc. es una empresa de tecnología que cree que una idea bien pensada tiene el poder de cambiar el mundo. Su cartera de productos y servicios de sistemas personales, impresoras y soluciones de impresión 3D ayuda a hacer realidad estas ideas.</p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:hp.instagram@hp.com" class="text-white topLinkGold">hp.instagram@hp.com</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <a href="mailto:hp.instagram@hp.com" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-envelope"></span>
                                                <span>hp.instagram@hp.com</span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="https://demo.cityplacecr.com/images/Oficinas/Hp/banner.jpg" data-alt="Hp Inc City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="https://demo.cityplacecr.com/images/Oficinas/Hp/banner.jpg" data-alt="Hp Inc City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="https://demo.cityplacecr.com/images/Oficinas/Hp/banner.jpg" data-alt="Hp Inc City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="https://demo.cityplacecr.com/images/Oficinas/Hp/banner.jpg" data-alt="Hp Inc City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Hp Inc Costa Rica</h5>

                                        <h2 class="sg-mb-20px">Inspírate y libera tu creatividad </h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                        
                                            <p>
                                                <a href="https://www.hp.com/lamerica_nsc_cnt_amer-es/home.html" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Visita Página</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Oficinas/Hp/2.jpg" class="bg-image lazyload" data-alt="Hp Inc City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="https://demo.cityplacecr.com/images/Oficinas/Hp/1.jpg" class="bg-image lazyload" data-alt="Hp Inc City Place"></div>
                                    </figure>
                                </div>
