                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="images/banners-categorias/logo1-corebases.png" alt="Corebases City Place" class="sg-mb-30px sg-hero-logo invert" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                                El Software a la medida crea un escenario que satisface necesidades específicas
                                                y mejora el desempeño de la compañía por medio de procesos efectivos.
                                                Especialistas en protección en ataques de DDOS.</p>
                                        </div>
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel:+506 4300 4941" class="text-white plusicon_ar topLinkGold">+506 4300 4941</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:contacto@corebases.com" class="text-white topLinkGold">contacto@corebases.com</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel: +506 4300 4941" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 4300 4941</span>
                                            </a>
                                            <a href="tel: +506 4300 4941" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 4300 4941</span>
                                            </a>
                                            <a href="mailto:contacto@corebases.com" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-envelope"></span>
                                                <span>contacto@corebases.com</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="images/banners-categorias/bannerlargo1-corebases.jpg" data-alt="Corebases City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="images/banners-categorias/bannerlargo1-corebases.jpg" data-alt="Corebases City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="images/banners-categorias/bannerlargo1-corebases.jpg" data-alt="Corebases City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="images/banners-categorias/bannerlargo1-corebases.jpg" data-alt="Corebases City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Corebases</h5>

                                        <h2 class="sg-mb-20px">El Software a la medida</h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                          

                                            <p>
                                                <a href="https://www.corebases.com/"  target="_blank" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Visita Sitio Web</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/2-corebases.jpeg" class="bg-image lazyload" data-alt="Corebases City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/5-corebases.jpeg" class="bg-image lazyload" data-alt="Corebases City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/1-corebases.jpeg" class="bg-image lazyload" data-alt="Corebases City Place"></div>
                                    </figure>
                                </div>
                            </div>
                        </div>
