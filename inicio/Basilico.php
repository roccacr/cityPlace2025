                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="images/banners-categorias/logo-basilico.png" alt="Basilico City Place" class="sg-mb-30px sg-hero-logo invert" />
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">PANINI&SALAD BAR
                                                Estamos en City Place Santa Ana, 200m norte de la Cruz Roja.
                                                ¡Somos lo que tu estilo de vida necesita!
                                                Gastronomía natural y consciente.</p>
                                        </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="images/banners-categorias/banner-basilico.jpg" data-alt="Basilico City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="images/banners-categorias/banner-basilico.jpg" data-alt="Basilico City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="images/banners-categorias/banner-basilico.jpg" data-alt="Basilico City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="images/banners-categorias/banner-basilico.jpg" data-alt="Basilico City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Basilico</h5>

                                        <h2 class="sg-mb-20px">MUY PRONTO <br> en City Place Santa Ana </h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            <p class="clearfix">
                                                Una alimentación limpia y consciente dará a tu cuerpo el balance que necesitas.

                                                ¡Te esperamos!
                                            </p>
                                            
                                            <p>
                                                <a href="https://www.facebook.com/basilicocr" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">MÁS INFORMACIÓN</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/3-basilico.jpg" class="bg-image lazyload" data-alt="Basilico City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/2-basilico.jpg" class="bg-image lazyload" data-alt="Basilico City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/1-basilico.jpg" class="bg-image lazyload" data-alt="Basilico City Place"></div>
                                    </figure>
                                </div>
