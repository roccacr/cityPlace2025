                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="images/Oficinas/MSD/logo1.png" alt="   MSD Costa Rica City Place" class="sg-mb-30px sg-hero-logo invert" />
                                            ...
                                            <div class="row" id="end_gold_twig_inside">
                                                <div class="col-sm-24 col-md-10">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="tel: +506 0507 1027" class="text-white plusicon_ar topLinkGold">+506 0507 1027</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="col-sm-24 col-md-14">
                                                    <p class="text-white">
                                                        ...
                                                        <a href="mailto:dpoc.centralamerica@merck.com." class="text-white topLinkGold">dpoc.centralamerica@merck.com.</a>
                                                    </p>
                                                </div>
                                    ...
                                    <div class="row visible-xs sg-mb-20px" id="icon_reverse_ar">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            <a href="tel: +506 0507 1027" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 0507 1027</span>
                                            </a>
                                            <a href="tel: +506 0507 1027" class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-phone"></span>
                                                <span>+506 0507 1027</span>
                                            </a>
                                            <a href="mailto:dpoc.centralamerica@merck.com." class="btn btn-default-transparent text-uppercase visible-xs">
                                                <span class="icon-envelope"></span>
                                                <span>dpoc.centralamerica@merck.com.</span>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="images/Oficinas/MSD/banner2.png" data-alt="MSD City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="images/Oficinas/MSD/banner2.png" data-alt="MSD City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="images/Oficinas/MSD/banner2.png" data-alt="MSD City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="images/Oficinas/MSD/banner2.png" data-alt="MSD City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">MSD Costa Rica</h5>

                                        <h2 class="sg-mb-20px">Inventamos para la vida </h2>

                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">

                                            <p class="clearfix">
                                                Inventamos para un futuro más esperanzador.
                                            </p>

                                            <p>
                                                <a href="https://www.corporativo.msd.co.cr/#:~:text=Desempe%C3%B1amos%20un%20papel%20importante%20en,el%20VIH%20y%20el%20%C3%A9bola." class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Visita Página</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/Oficinas/MSD/2.jpg" class="bg-image lazyload" data-alt="MSD City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/Oficinas/MSD/1.jpg" class="bg-image lazyload" data-alt="MSD City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/Oficinas/MSD/3.jpg" class="bg-image lazyload" data-alt="MSD City Place"></div>
                                    </figure>
                                </div>
