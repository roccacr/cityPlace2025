                        ...
                        <div class="block-slide">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-22 col-sm-offset-1">
                                            ...
                                            <img src="images/banners-categorias/logo-bookingcom.png" alt="Booking.com City Place" class="sg-mb-30px sg-hero-logo invert"  style="min-height:75px"/>
                                    ...
                                    <div class="row hidden-xs" id="end_gold_twig">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <p class="text-white">
                                                Desde apartamentos, casas de vacaciones y B&B hasta resorts de lujo de 5 estrellas, casas en los árboles e incluso iglús, cubrimos todo tipo de viaje y todo tipo de viajero.</p>
                                        </div>
                            ...
                            <div class="block-visuals">
                                ...
                                <figure class="block-cover-img">
                                    <div class="bg-image lazyload visible-xs-block" data-bgset="images/banners-categorias/banner-bookingcom.jpg" data-alt="Booking.com City Place"></div>
                                    <div class="bg-image lazyload visible-sm-block" data-bgset="images/banners-categorias/banner-bookingcom.jpg" data-alt="Booking.com City Place"></div>
                                    <div class="bg-image lazyload visible-md-block" data-bgset="images/banners-categorias/banner-bookingcom.jpg" data-alt="Booking.com City Place"></div>
                                    <div class="bg-image lazyload visible-lg-block" data-bgset="images/banners-categorias/banner-bookingcom.jpg" data-alt="Booking.com City Place"></div>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="block-content">
                                <div class="display-table">
                                    <div class="display-table-cell col-middle text-center">
                                        <h5 class="sg-mb-25px text-uppercase" style="font-size: 20px;">Booking.com</h5>

                                        <h2 class="sg-mb-20px">#BackToTravel </h2>
                                        ...
                                        <div class="col-lg-12 col-lg-offset-6 col-md-18 col-md-offset-3 sg-mb-30px">
                                            ...
                                            <p>
                                                <a href="https://www.booking.com/index.es.html?label=fac419jc-1DCAEoggI46AdIM1gDaDOIAQGYAQq4ARfIAQzYAQPoAQH4AQOIAgGoAgO4AvT8yJUGwAIB0gIkYzkzMTU3MDktMDA2Yi00YTRhLTljMjMtZTliYjhiMDZlYWMy2AIE4AIB&sid=1803b7e6124fed69f4abee3d481fcd52&keep_landing=1&sb_price_type=total&" class="btn btn-primary-transparent btn-block text-uppercase plusicon_ar" style="border-color: #000;">Más Información</a>
                                            </p>
                        ...
                        <div class="block block-border-left col-md-14 col-sm-12" data-block>
                            ...
                            <div class="slick-light slick-dots-reset slick-full-height" data-slick data-slick-options="{'arrows': false, 'dots': true, 'infinite': true, 'slidesToShow': 1, 'slidesToScroll': 1}">
                                ...
                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/2-bookingcom.jpg" class="bg-image lazyload" data-alt="Booking.com City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/1-bookingcom.jpg" class="bg-image lazyload" data-alt="Booking.com City Place"></div>
                                    </figure>
                                </div>

                                <div class="slick-slide">
                                    <figure class="block-cover-img">
                                        <div data-bgset="images/banners-categorias/3-bookingcom.jpg" class="bg-image lazyload" data-alt="Booking.com City Place"></div>
                                    </figure>
                                </div>
